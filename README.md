...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/emc2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10838&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/emc2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `emc2` can be installed with:

```
conda install emc2
```

It is possible to list all of the versions of `emc2` available on your platform with:
